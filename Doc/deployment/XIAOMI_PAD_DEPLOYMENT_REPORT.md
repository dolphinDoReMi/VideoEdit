...
### 🔒 Permissions Policy (Xiaomi Pad)
- No install-time special permissions required
- No runtime storage/media permissions required for file selection or reading
- File/media access via Android SAF with user-granted URI access
- Applies across Whisper, UI, and Clip flows
