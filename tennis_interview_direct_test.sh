...
# 🎬 TennisInterview.mp4 Auto-Clipper Direct Test
# This script directly tests the Auto-Clipper functionality

set -e

echo "🎬 TennisInterview.mp4 Auto-Clipper Direct Test"
echo "==============================================="
echo ""
...
echo "🎉 TennisInterview.mp4 Auto-Clipper Direct Test Complete!"
echo "========================================================="
echo ""
