...
# Process Tennis Interview Clip 001 using WebView JavaScript Interface
# This approach uses the app's built-in WebView to process the file
...
echo "🎾 Processing Tennis Interview Clip 001 (WebView Approach)"
echo "========================================================"
echo ""
...
echo ""
echo "🚀 Starting transcription processing via WebView..."

# Use the WebView's JavaScript interface to process the file
# This simulates what the web interface would do
adb shell "am start -n com.mira.com/com.mira.whisper.WhisperMainActivity \
    --es 'action' 'process_via_webview' \
...
echo "✅ WebView processing initiated!"
echo ""
...
while true; do
    ...
    COMPLETION_LOG=$(adb logcat -d | grep -E "(Completed.*job|TECHNICAL.*Transcription completed|WebView.*completed)" | tail -1)
