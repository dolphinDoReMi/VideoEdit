...
/**
 * Core configuration constants for mira infrastructure.
 * 
 * Centralizes defaults for various services and components.
 */
object Config {
    /**
    ...
    /**
     * Root output directory for all mira artifacts.
    ...
    const val CLIP_DIM = 512
    const val DEFAULT_MEMORY_BUDGET_MB = 512
