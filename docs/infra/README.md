...
## Overview
This directory contains consolidated documentation for the core infrastructure services that provide centralized file management, duplicate detection, and global cleanup operations across all modules in the VideoEdit application.
